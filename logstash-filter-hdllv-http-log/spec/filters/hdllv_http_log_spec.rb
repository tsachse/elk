...
describe LogStash::Filters::HdllvHttpLog do
  describe "Felder splitten" do
    ...
    sample("2016.03.04 05:03:39 10.177.227.116 /akstat (GET)") do
      ...
      insist { subject["@timestamp"] } == LogStash::Timestamp.new(Time.strptime('2016.03.04 05:03:39', '%Y.%m.%d %H:%M:%S'))
    end
  end
  ...
  describe "Folgezeilen bearbeiten" do
    ...
    sample(["2016.03.04 05:03:39 10.177.227.116 /akstat (GET)","Folgezeile"]) do
      ...
      insist { subject[0]["@timestamp"] } == LogStash::Timestamp.new(Time.strptime('2016.03.04 05:03:39', '%Y.%m.%d %H:%M:%S'))
      ...
      insist { subject[1]["@timestamp"] } == LogStash::Timestamp.new(Time.strptime('2016.03.04 05:03:39', '%Y.%m.%d %H:%M:%S'))
    end
  end
